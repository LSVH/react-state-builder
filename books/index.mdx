...
onInitAction | Used to dispatch an onInit action. <br /> *`(payload: any) => `[`OnInitActionType`](#type-OnInitActionType)*
onLoadAction | Used to dispatch an onLoad action. <br /> *`(property: string, payload?: any, bulk: boolean = false) => `[`OnLoadActionType`](#type-OnLoadActionType)*
beforeOnLoadAction | Used to dispatch an beforeOnLoadAction action. <br /> *`(property: string) => `[`BeforeOnLoadActionType`](#type-BeforeOnLoadActionType)*
setLoadingState | Toggle the value of the `loading` property of a certain sub state. <br /> *`(state: `[`StateType`](#type-StateType)`, type: string) => void`*
